...
def extractGeometry (json, metadata): 
    try:
        ...
        print("jsonGeometry in extract Geometry")
        print(jsonGeometry)
        return jsonGeometry
        
    except AttributeError, e:
        print('AttributeError: Warning: missing metadata. Could not extract geometry')
        print e
        return jsonGeometry 

    except TypeError, e:
        print('TypeError: Warning: missing metadata. Could not extract geometry')
        print e
        return jsonGeometry 
...
#search in Json File for Coordinate Arrays
